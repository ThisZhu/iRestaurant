 ...
 */
public class MyCouponActivity extends BaseActivity implements IActivity {
    ...
    public void initView() {
        ...
        texview_my_review.setText("我的代金券");
    }
    ...
    View.OnClickListener OnClickListener_back=new View.OnClickListener() {
        ...
        public void onClick(View view) {
            goToOtherClass(intent,MyCouponActivity.this, MainActivity.class,1);
        }
    };
