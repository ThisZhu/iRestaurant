 ...
 */
public class MyCollectionsActivity extends BaseActivity implements IActivity {
    private Intent intent=new Intent();
    public TextView texview_back;
    public ListView my_review;
    public TextView texview_my_review;
    ...
    public void initView() {
        ...
        texview_my_review=$(R.id.texview_my_review);
        texview_my_review.setText("我的收藏");
    }
    ...
    View.OnClickListener OnClickListener_back=new View.OnClickListener() {
        ...
        public void onClick(View view) {
            goToOtherClass(intent,MyCollectionsActivity.this, MainActivity.class,1);
        }
    };
